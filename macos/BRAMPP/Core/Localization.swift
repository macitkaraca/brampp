...
enum L10n {
    static let catalog: [String: [String: String]] = [
        ...
        "diag.running": ["tr": "Denetimler çalışıyor…", "en": "Running the checks…"],
        "diag.clean":   ["tr": "SORUN YOK", "en": "ALL CLEAR"],
        "diag.count":   ["tr": "%d bulgu", "en": "%d findings"],
        "diag.rerun":   ["tr": "Yeniden çalıştır", "en": "Run again"],
        "diag.repairAlias":      ["tr": "Yapılandırmayı onar", "en": "Repair configuration"],
        "diag.repairAlias.help": ["tr": "phpMyAdmin/Adminer yapılandırmasındaki Alias sırasını düzeltir. Eski dosya .brampp.bak olarak yedeklenir; configtest geçmezse yedekten geri alınır.", "en": "Fixes the Alias order in the phpMyAdmin/Adminer configuration. The old file is backed up as .brampp.bak and restored if configtest fails."],
        "diag.lastRun": ["tr": "Son çalıştırma: %@", "en": "Last run: %@"],
        "diag.menu":    ["tr": "Teşhis", "en": "Diagnostics"],
        "php.prof.title":       ["tr": "Profilleyici", "en": "Profiler"],
        "php.prof.on":          ["tr": "AÇIK", "en": "ON"],
        "php.prof.desc":        ["tr": "Xdebug'ın profil kipini buradan açıp kapatabilirsiniz; php.ini elle düzenlenmez. Çıktılar cachegrind biçiminde üretilir ve qcachegrind/KCachegrind ile açılır.", "en": "Turn Xdebug's profile mode on and off here instead of editing php.ini by hand. Output is written in cachegrind format, which qcachegrind/KCachegrind opens."],
        "php.prof.enable":      ["tr": "Profilleyiciyi aç", "en": "Enable the profiler"],
        "php.prof.always":      ["tr": "Her isteği profille", "en": "Profile every request"],
        "php.prof.alwaysNote":  ["tr": "Kapalıyken yalnızca XDEBUG_TRIGGER taşıyan istekler ölçülür — sitenin geri kalanı normal hızda çalışır. Açarsanız her istek yavaşlar ve disk hızla dolar.", "en": "While off, only requests carrying XDEBUG_TRIGGER are measured — the rest of the site runs at normal speed. Turn it on and every request slows down and the disk fills fast."],
        "php.prof.needsXdebug": ["tr": "Profilleyici Xdebug'a bağlıdır. Yukarıdaki listeden bu PHP sürümü için xdebug eklentisini etkinleştirin.", "en": "The profiler needs Xdebug. Enable the xdebug extension for this PHP version in the list above."],
        "php.prof.restart":     ["tr": "Ayar php.ini'ye yazıldı. Web isteklerinde geçerli olması için bu sürümün PHP-FPM servisini yeniden başlatın.", "en": "The setting was written to php.ini. Restart this version's PHP-FPM service for it to apply to web requests."],
        "php.prof.howTrigger":  ["tr": "Ölçmek istediğiniz isteğe XDEBUG_TRIGGER ekleyin — örneğin: https://projem.test/?XDEBUG_TRIGGER=1", "en": "Add XDEBUG_TRIGGER to the request you want to measure — for example: https://myproject.test/?XDEBUG_TRIGGER=1"],
        "php.prof.files":       ["tr": "Profil dosyaları", "en": "Profile files"],
        "php.prof.none":        ["tr": "Henüz profil üretilmedi.", "en": "No profiles produced yet."],
        "php.prof.folder":      ["tr": "Klasörü aç", "en": "Open the folder"],
        "php.prof.clear":       ["tr": "Tümünü sil", "en": "Delete all"],
        "php.prof.clearTitle":  ["tr": "Profil dosyaları silinsin mi?", "en": "Delete the profile files?"],
        "php.prof.clearMsg":    ["tr": "Üretilmiş tüm cachegrind dosyaları silinecek. Bu işlem geri alınamaz.", "en": "Every cachegrind file produced so far will be deleted. This cannot be undone."],
        "php.prof.more":        ["tr": "…ve %d dosya daha", "en": "…and %d more files"],
        "cat.mail":          ["tr": "Posta", "en": "Mail"],
        "svc.mailpit.open":  ["tr": "Posta kutusunu aç", "en": "Open the mailbox"],
        "svc.mailpit.hint":  ["tr": "SMTP 127.0.0.1:1025 — uygulamanız buraya gönderir, posta dışarı ÇIKMAZ", "en": "SMTP 127.0.0.1:1025 — your app sends here and no mail leaves the machine"],
        ...
        "upd.check.title":            ["tr": "Güncellemeler denetleniyor", "en": "Checking for updates"],
        "upd.check.detail":           ["tr": "Yeni bir sürüm var mı diye bakılıyor. Birkaç saniye sürebilir.", "en": "Looking for a newer version. This can take a few seconds."],
        "upd.check.upToDate.title":   ["tr": "BRAMPP güncel", "en": "BRAMPP is up to date"],
        "upd.check.upToDate.detail":  ["tr": "Kurulu sürüm %@ ve yayınlanmış daha yenisi yok.", "en": "You are on %@ and there is nothing newer published."],
        "upd.check.failed.title":     ["tr": "Denetim yapılamadı", "en": "The check could not run"],
        "upd.check.failed.detail":    ["tr": "Sürüm bilgisine ulaşılamadı. İnternet bağlantınızı denetleyip yeniden deneyin.", "en": "The version information could not be reached. Check your connection and try again."],
        "upd.action.installNow":     ["tr": "Güncelle ve yeniden başlat", "en": "Update and restart"],
        "upd.action.installingNow":  ["tr": "Hazırlanıyor…", "en": "Preparing…"],
        "upd.selfFail.blocked":   ["tr": "Bu kurulum yerinde güncellenemiyor (uygulamanın bulunduğu klasöre yazılamıyor). Kalıbı açıp BRAMPP'ı Uygulamalar'a sürükleyin.", "en": "This copy cannot be updated in place — the folder holding the app is not writable. Open the image and drag BRAMPP to Applications."],
        "upd.selfFail.mount":     ["tr": "Disk kalıbı bağlanamadı. Kalıbı elle açıp sürükleyebilirsiniz.", "en": "The disk image could not be mounted. You can open it and drag manually."],
        "upd.selfFail.missing":   ["tr": "Kalıbın içinde BRAMPP.app bulunamadı — indirme bozuk olabilir. Yeniden indirmeyi deneyin.", "en": "BRAMPP.app was not found inside the image — the download may be damaged. Try downloading again."],
        "upd.selfFail.copy":      ["tr": "Yeni sürüm kopyalanamadı; kurulu sürüm olduğu gibi duruyor. Kalıbı açıp elle sürükleyebilirsiniz.", "en": "The new version could not be copied; your installed version is untouched. You can open the image and drag manually."],
        "upd.selfFail.signature": ["tr": "İndirilen dosya denetimden geçmedi — kurulum YAPILMADI. Yeniden indirmeyi deneyin.", "en": "The download did not pass the check — nothing was installed. Try downloading again."],
        "upd.selfFail.team":      ["tr": "İndirilen dosya BRAMPP'ın yayıncısından gelmiyor — kurulum yapılmadı. İndirmeyi kendiniz başlatmadıysanız bu bağlantıya güvenmeyin.", "en": "The download did not come from BRAMPP's publisher — nothing was installed. If you did not start this download yourself, do not trust it."],
        "upd.selfFail.notary":    ["tr": "İndirilen dosya doğrulanamadı — kurulum yapılmadı. İnternet bağlantınız yoksa daha sonra deneyin.", "en": "The download could not be verified — nothing was installed. If you are offline, try again later."],
        "upd.selfFail.script":    ["tr": "Güncelleme hazırlığı yazılamadı; kurulu sürüm olduğu gibi duruyor.", "en": "The update step could not be written; your installed version is untouched."],
        ...
        "upd.dl.verifying":     ["tr": "İndirilen dosya denetleniyor…",
        ...
        "upd.fail.codesign":    ["tr": "indirilen dosya bozuk ya da değiştirilmiş",
                                 "en": "the signature did not verify (codesign)"],
        "upd.fail.team":        ["tr": "bu dosya BRAMPP'ın yayıncısından gelmiyor",
                                 "en": "the developer Team ID does not match this app's"],
        "upd.fail.gatekeeper":  ["tr": "indirilen dosya doğrulanamadı",
