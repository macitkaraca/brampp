...
enum L10n {
    static let catalog: [String: [String: String]] = [
        ...
        "upd.selfFail.signature": ["tr": "Kopyalanan paketin imzası doğrulanamadı — kurulum YAPILMADI. Yeniden indirmeyi deneyin.", "en": "The copied bundle failed signature verification — nothing was installed. Try downloading again."],
        "upd.selfFail.team":      ["tr": "İndirilen paket BAŞKA bir geliştirici kimliğiyle imzalanmış — kurulum yapılmadı. İndirmeyi kendiniz başlatmadıysanız bu bağlantıya güvenmeyin.", "en": "The downloaded bundle is signed by a different developer identity — nothing was installed. If you did not start this download yourself, do not trust it."],
        "upd.selfFail.notary":    ["tr": "Apple noter onayı doğrulanamadı — kurulum yapılmadı. İnternet bağlantınız yoksa daha sonra deneyin.", "en": "Apple notarization could not be confirmed — nothing was installed. If you are offline, try again later."],
