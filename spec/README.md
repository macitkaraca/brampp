...
an assistant sees, the manifest a project carries, and the file an updater reads.
...
| [`brampp-yml.md`](brampp-yml.md) | The project manifest that makes a domain portable between machines |
...
argument that means something else, or invent its own manifest keys.
